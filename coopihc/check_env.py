################################
####
#### This file is a copy of Stable_baselines, see here: https://stable-baselines.readthedocs.io/en/master/_modules/stable_baselines/common/env_checker.html#check_env   but without the _check_nan test that needs stable_baseline import.
####
################################
...
def _check_unsupported_obs_spaces(
    ...
    if isinstance(observation_space, spaces.Dict) and not isinstance(env, gym.GoalEnv):
        warnings.warn(
            ...
            "(cf https://github.com/openai/gym/blob/master/gym/coopihc.py), "
...
def check_env(env: gym.Env, warn: bool = True, skip_render_check: bool = True) -> None:
    ...
    Please take a look at https://github.com/openai/gym/blob/master/gym/coopihc.py
