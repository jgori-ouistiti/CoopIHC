...
if _str == "cast" or _str == "all":
    ...
    x = StateElement(
        values=[4], spaces=[coopihc.space.Discrete(9)], possible_values=[[None]]
    )
    ...
    b = StateElement(
        values=[None], spaces=[coopihc.space.Discrete(9)], possible_values=[[None]]
    )

    c = StateElement(
        values=[None], spaces=[coopihc.space.Discrete(58)], possible_values=[[None]]
    )
    ...
    x = StateElement(
        values=[0],
        spaces=[coopihc.space.Box(-2, 2, shape=(1,))],
        possible_values=[None],
    )
    ...
    for i in range(31):
        x = StateElement(
            values=[i], spaces=[coopihc.space.Discrete(31)], possible_values=[[None]]
        )
        y = StateElement(
            values=[None],
            spaces=[coopihc.space.Box(-1, 1, shape=(1,))],
...
if _str == "matmul" or _str == "all":
    x = StateElement(
        ...
        spaces=[
            coopihc.space.Box(
                low=-numpy.inf * numpy.ones((2, 2)),
                high=numpy.inf * numpy.ones((2, 2)),
                shape=(2, 2),
            )
        ],
        possible_values=[[None]],
    ...
    z = numpy.ones((2, 2))
    w = StateElement(
        values=[numpy.ones((2, 1))],
        spaces=[
            coopihc.space.Box(
                low=-numpy.inf * numpy.ones((2, 1)),
                high=numpy.inf * numpy.ones((2, 1)),
                shape=(2, 1),
            )
        ],
        possible_values=[[None]],
...
if _str == "mode" or _str == "all":
    x = StateElement(
        values=[3 * numpy.ones((2, 2))],
        spaces=[coopihc.space.Box(low=-1, high=1, shape=(2, 2))],
        possible_values=[[None]],
        clipping_mode="clip",
    )
    print(x)
