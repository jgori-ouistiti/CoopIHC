...
\begin{tikzpicture}
	...
	\draw ($(origin) + (0,2)$) node[name = task_state, minimum height = 1cm, basic box = \taskcolor]{\texttt{Task State}};
	...
	% # ========== User ==========
	% ------------- State ---------
	\draw ($(origin) + (1*\x,-1*\y)$) node[name = user_state, basic box = \statecolor]{\texttt{State}};
	% ------------- Observation ---------
	...
	% # ========== Assistant ==========
	% ------------- State ---------
	\draw ($(origin) + (-1*\x,-1*\y)$) node[name = assistant_state, basic box = \statecolor]{\texttt{State}};
	% ------------- Observation ---------
