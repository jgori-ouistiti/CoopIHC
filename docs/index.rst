...
*CoopIHC* (pronounced "kopik") is a Python module that provides a common basis for describing **computational Human Computer Interaction (HCI)** contexts, mostly targeted at expressing models of users and intelligent assistants. See our `paper <https://jgori-ouistiti.github.io/academic/files/main_manuscript.pdf>`
