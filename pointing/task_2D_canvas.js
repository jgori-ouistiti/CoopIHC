            ...
            class PointingTaskManager{
                constructor(){
                    ...
                    this.__targets = null;
                    this.__operator_action_text = document.querySelector('.operator_action');
                    this.__operator_action = null;
                ...
                get operator_action(){
                    return this.__operator_action;
                }

                set operator_action(value){
                    this.__operator_action = value;
                    this.__operator_action_text.textContent = value.toString();
                }
            ...
            function on_operator_action(received_dic){

                var is_done = false;

                // convert action
                action = unpack_actions(received_dic);
                console.log("operator_action", action);
                pointing_task_manager.operator_action = action;
                if (action == 0){
                    is_done = true;
                }
            ...
            function on_assistant_action(received_dic){
                ...
                console.log("task  dynamics", pointing_task_manager.position, pointing_task_manager.operator_action, pointing_task_manager.assistant_action);
                pointing_task_manager.position += pointing_task_manager.operator_action*pointing_task_manager.assistant_action;
            ...
            websocket.onmessage = function (event) {
                ...
                switch (data_type) {
                    ...
                    case 'operator_action':
                        on_operator_action(dic_received);
                        break;
